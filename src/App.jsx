  ...
  return (
    <div style={{ minHeight:"100vh", background:"#0a0e1a", display:"flex", alignItems:"center", justifyContent:"center", fontFamily:"'DM Sans', sans-serif", padding:20 }}>
      ...
      <div style={{ background:"#111626", border:"1.5px solid #1e2540", borderRadius:24, padding:"40px 36px", width:"100%", maxWidth:400, textAlign:"center" }}>
        ...
        <input
          style={{ background:"#151b30", border:"1.5px solid #252d48", borderRadius:12, color:"#e8eaf0", fontFamily:"inherit", fontSize:16, padding:"14px 18px", outline:"none", width:"100%", marginBottom:10, textAlign:"center", boxSizing:"border-box" }}
          placeholder="Tu nombre..."
          value={nombre}
          onChange={e => { setNombre(e.target.value); setError(""); setPassword(""); }}
          onKeyDown={e => e.key === "Enter" && !esAdmin && handleLogin()}
          autoFocus
        />
        {esAdmin && (
...
export default function StockBebidas() {
  ...
  const aplicarFiltroFechas = () => { setHistFiltro({ ...histFiltro, rapido:"" }); cargarHistorial(histFiltro.desde, histFiltro.hasta); };
        ...
        <div style={{ maxWidth:1140, margin:"0 auto", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:12 }} className="top-actions">
          <div>
            ...
            <p style={{ fontSize:12, color:"#5a6480" }}>
              {bebidas.length} productos · <span style={{ color:"#34d399" }}>● Sincronizado</span>
            </p>
          </div>
